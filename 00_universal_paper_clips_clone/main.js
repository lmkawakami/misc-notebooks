const tableMainColor = '#aaaaaa'
const tableAltColor = '#1a1a1a'
...
function round(roundNum){
    ...
    function clearGrid() {
        ...
        var w = document.getElementById("payoffCellAA");
        w.style.backgroundColor = tableMainColor;
        w.style.color = tableAltColor;
        
        var x = document.getElementById("payoffCellAB");
        x.style.backgroundColor = tableMainColor;
        x.style.color = tableAltColor;
        
        var y = document.getElementById("payoffCellBA");
        y.style.backgroundColor = tableMainColor;
        y.style.color = tableAltColor;
        
        var z = document.getElementById("payoffCellBB");
        z.style.backgroundColor = tableMainColor;
        z.style.color = tableAltColor;
...
function cheatOps(){
    standardOps = standardOps + 1000000;
...
function toggleCheats(){
    ...
    cheatsEnabled?displayMessage("Cheats ON, sneaky bastard!"):displayMessage("Cheats OFF, good puppy!");
    cheats = document.getElementById("cheats-div");
    cheats.style.bottom = cheatsEnabled?'5px':'-200px';
}
